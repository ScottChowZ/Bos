...
public class SmsUtils {
    ...
    static final String accessKeyId = "LTAIkuSzqrvx4LVP";
    static final String accessKeySecret = "04TgL9J6AWVQjMNOjbY6lnqtEHlZEf";
    ...
    public static SendSmsResponse sendSms(String telephone, String code)
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("周志强");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_128560090");
